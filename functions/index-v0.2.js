...
const VULOG_FLEET_ID = 'DEMO-FF';
const VULOG_API_CLIENT_ID = 'DEMO-FF_secure';
const VULOG_API_CLIENT_SECRET = '9e0b8b69-5dbf-45c3-a8cd-f764937dac58';
const VULOG_API_CLIENT_KEY= '1720171f-2b6d-4c58-905b-94d8ab7cc6ce';
...
/*******************************************************************************************************************************
 *  HERE THE VULOG API INTEGRATION TENTATIVE ==> not sure it worths it with the emulator workaround .....
 *******************************************************************************************************************************/
...
const vulog_api_login = (uid, username, password, next, failure) => {
	let url = 'https://demo-java-api.vulog.com:484/auth/realms/'  + VULOG_FLEET_ID + '/protocol/openid-connect/token';
	let formParams = {
...
/*** Integtation with Vulog BO ==> not tested ***/
